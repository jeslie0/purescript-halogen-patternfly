(() => {
  ...
  var thunk1 = function(f, a2) {
    return thunk(unsafeThunkId(f), refEq2, f, a2);
  };
  ...
  var lazy = function(f) {
    return function(a2) {
      return widget(new ThunkSlot(thunk1(f, a2)));
    };
  };
  ...
  // output/Properties/index.js
  var isFilled = function(bool) {
    return function(conf) {
      var $28 = {};
      for (var $29 in conf) {
        if ({}.hasOwnProperty.call(conf, $29)) {
          $28[$29] = conf[$29];
        }
        ;
      }
  ...
  var buildOptions = function(opArray) {
    return function(init2) {
      return function __do2() {
        var curOpRef = init2;
        foreach(opArray)(function(v) {
          return function __do3() {
            curOpRef = v(curOpRef);
            return unit;
          };
  ...
  // output/Patternfly.Card/index.js
  var append5 = /* @__PURE__ */ append(semigroupArray);
  var initialBodyOptions = {
    isFilled: true
  };
  var classNames = {
    card: "pf-v5-c-card",
  ...
  var body2 = function(arr) {
    return function(attr3) {
      var bodyOptions = buildOptions(arr)(initialBodyOptions);
      var isFilledClass = function() {
        if (bodyOptions.isFilled) {
          return "";
        }
        ;
        return classNames.bodyNoFill;
      }();
      return div2(append5(attr3)([classes([isFilledClass, classNames.body])]));
    };
  };
